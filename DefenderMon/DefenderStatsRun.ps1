...
$OrgFile     = "\TheNetWorks\DefenderStatsBOM.txt"
$StatsData   = "\TheNetWorks\DefenderStats.txt"
$StatsPolicy = "\TheNetWorks\DefenderStats.cfg"
$VerFile     = "\TheNetWorks\DefenderVer.cfg"
